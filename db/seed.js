...
const products = seed(Product, {
  one: {name: 'Jasmine', price: 2.25, img:'https://www.organicfacts.net/wp-content/uploads/2013/06/Jasmine-tea.jpg', category: 'vegan'},
  two:  {name: 'Black', price: 2.75, img:'http://demandware.edgesuite.net/sits_pod26/dw/image/v2/AAFV_PRD/on/demandware.static/-/Sites-Teavana_Master_Catalog/default/dw58701317/images/Product%20Images/Tea/32258_earlgreytea_Hol16.jpg?sw=1000&sh=1000', category: 'unhealthy'},
  three:  {name: 'Earl Gray', price: 3.00, img:'http://us.palaisdesthes.com/media/catalog/product/cache/4/image/450x450/9df78eab33525d08d6e5fb8d27136e95/8/0/803_blue-of-london-earl-grey-du-yunnan_3.jpg', category: 'kosher'},
  four: {name: 'Peppermint', price: 2.25, img:'http://www.teapeople.co.uk/media/catalog/product/cache/1/image/aca7c15394bfd51561ecb1df063b923e/p/e/peppermint.jpg', category: 'vegan'},
  five:  {name: 'Apple Tea', price: 2.75, img:'https://bluebirdteaco.com/media/catalog/product/cache/1//a/n/ankara-apple_1_2.png/9df78eab33525d08d6e5fb8d27136e95/a/n/ankara_apple.png', category: 'unhealthy'},
  six:  {name: 'Rose Tea', price: 3.00, img:'http://demandware.edgesuite.net/sits_pod26/dw/image/v2/AAFV_PRD/on/demandware.static/-/Sites-Teavana_Master_Catalog/default/dw23bd32b2/images/Product%20Images/Tea/Green%20Tea/31355_sakuraallurertea.jpg?sw=450&sh=450', category: 'kosher'}
})
